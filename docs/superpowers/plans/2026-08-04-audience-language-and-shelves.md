...
| app.html createBuiltinAgent subtitle | "A hosted agent powered by a frontier model. It appears on your agent cards here and becomes selectable from the NewWorldTrading Discord server with `/agent`." | "A hosted agent powered by a leading AI model. It appears on your agent cards here and can also be used from our Discord community with `/agent`." |
