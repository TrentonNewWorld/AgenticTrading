...
**Filed as [issue #273](https://github.com/TrentonNewWorld/NewWorldTrading/issues/273).** Not
...
- **Cancel a running backtest** — filed as
  [issue #273](https://github.com/TrentonNewWorld/NewWorldTrading/issues/273). Out of scope
  here; see B7.
