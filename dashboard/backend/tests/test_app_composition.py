...
EXPECTED_FULL_CONTRACT = {
    ...
    ("GET", "/api/admin/execution-settings"),
    ("PUT", "/api/admin/execution-settings/alpaca-live-execute"),
    ("POST", "/api/algo/chat"),
    ...
    ("GET", "/api/v1/wallets/portfolio-summary"),
    ("GET", "/api/v1/wallets/{asset_class}"),
    ("GET", "/strategy-catalog.html"),
    ("GET", "/strategy-edit.html"),
    ("GET", "/manual.html"),
    ("GET", "/api/v1/strategy-catalog"),
    ("DELETE", "/api/v1/strategy-catalog/{key}"),
    ("GET", "/api/v1/strategy-catalog/{key}/allocation"),
    ("PUT", "/api/v1/strategy-catalog/{key}/allocation"),
    ("GET", "/api/v1/strategy-catalog/{key}/params"),
    ("PUT", "/api/v1/strategy-catalog/{key}/params"),
    ("POST", "/api/v1/strategy-catalog/{key}/paper"),
    ("POST", "/api/v1/strategy-catalog/{key}/live"),
    ("GET", "/api/v1/strategy-catalog/{key}/activation"),
    ("POST", "/api/v1/strategy-catalog/{key}/paper/activate"),
    ("POST", "/api/v1/strategy-catalog/{key}/paper/deactivate"),
    ("POST", "/api/v1/strategy-catalog/{key}/live/activate"),
    ("POST", "/api/v1/strategy-catalog/{key}/live/deactivate"),
    ("GET", "/api/v1/strategy-catalog/{key}/report"),
    ("GET", "/api/v1/strategy-catalog/{key}/export"),
    ("GET", "/api/v1/options/strategy-catalog"),
    ("DELETE", "/api/v1/options/strategy-catalog/{key}"),
    ("GET", "/api/v1/options/strategy-catalog/{key}/report"),
    ("GET", "/api/v1/options/strategy-catalog/{key}/export"),
    ("GET", "/api/v1/options/leaderboard"),
    ("GET", "/api/v1/options/manual/status"),
    ("GET", "/api/v1/options/manual/strategies"),
    ("POST", "/api/v1/options/manual/strategies/upload"),
    ("POST", "/api/v1/options/manual/strategies/{key}/approve"),
    ("POST", "/api/v1/options/manual/strategies/{key}/reject"),
    ("DELETE", "/api/v1/options/manual/strategies/{key}"),
    ("POST", "/api/v1/options/manual/strategies/{key}/select"),
    ("POST", "/api/v1/options/manual/strategies/{key}/deselect"),
    ("POST", "/api/v1/options/manual/strategies/{key}/activate"),
    ("POST", "/api/v1/options/manual/strategies/{key}/deactivate"),
    ("GET", "/api/v1/options/manual/positions"),
    ("GET", "/api/v1/options/manual/calendar"),
    ("POST", "/api/v1/options/manual/positions/{position_id}/sell"),
    ("GET", "/api/v1/futures/manual/status"),
    ("GET", "/api/v1/futures/manual/strategies"),
    ("POST", "/api/v1/futures/manual/strategies/upload"),
    ("POST", "/api/v1/futures/manual/strategies/{key}/approve"),
    ("POST", "/api/v1/futures/manual/strategies/{key}/reject"),
    ("DELETE", "/api/v1/futures/manual/strategies/{key}"),
    ("POST", "/api/v1/futures/manual/strategies/{key}/select"),
    ("POST", "/api/v1/futures/manual/strategies/{key}/deselect"),
    ("POST", "/api/v1/futures/manual/strategies/{key}/activate"),
    ("POST", "/api/v1/futures/manual/strategies/{key}/deactivate"),
    ("GET", "/api/v1/futures/manual/positions"),
    ("GET", "/api/v1/futures/manual/calendar"),
    ("POST", "/api/v1/futures/manual/positions/{position_id}/sell"),
    ("GET", "/api/v1/futures/strategy-catalog"),
    ("DELETE", "/api/v1/futures/strategy-catalog/{key}"),
    ("GET", "/api/v1/futures/strategy-catalog/{key}/report"),
    ("GET", "/api/v1/futures/strategy-catalog/{key}/export"),
    ("GET", "/api/v1/futures/leaderboard"),
    ("GET", "/api/v1/forex/manual/status"),
    ("GET", "/api/v1/forex/manual/strategies"),
    ("POST", "/api/v1/forex/manual/strategies/upload"),
    ("POST", "/api/v1/forex/manual/strategies/{key}/approve"),
    ("POST", "/api/v1/forex/manual/strategies/{key}/reject"),
    ("DELETE", "/api/v1/forex/manual/strategies/{key}"),
    ("POST", "/api/v1/forex/manual/strategies/{key}/select"),
    ("POST", "/api/v1/forex/manual/strategies/{key}/deselect"),
    ("POST", "/api/v1/forex/manual/strategies/{key}/activate"),
    ("POST", "/api/v1/forex/manual/strategies/{key}/deactivate"),
    ("GET", "/api/v1/forex/manual/positions"),
    ("GET", "/api/v1/forex/manual/calendar"),
    ("POST", "/api/v1/forex/manual/positions/{position_id}/sell"),
    ("GET", "/api/v1/forex/strategy-catalog"),
    ("DELETE", "/api/v1/forex/strategy-catalog/{key}"),
    ("GET", "/api/v1/forex/strategy-catalog/{key}/report"),
    ("GET", "/api/v1/forex/strategy-catalog/{key}/export"),
    ("GET", "/api/v1/forex/leaderboard"),
    ("GET", "/api/v1/crypto/manual/status"),
    ("GET", "/api/v1/crypto/manual/strategies"),
    ("POST", "/api/v1/crypto/manual/strategies/upload"),
    ("POST", "/api/v1/crypto/manual/strategies/{key}/approve"),
    ("POST", "/api/v1/crypto/manual/strategies/{key}/reject"),
    ("DELETE", "/api/v1/crypto/manual/strategies/{key}"),
    ("POST", "/api/v1/crypto/manual/strategies/{key}/select"),
    ("POST", "/api/v1/crypto/manual/strategies/{key}/deselect"),
    ("POST", "/api/v1/crypto/manual/strategies/{key}/activate"),
    ("POST", "/api/v1/crypto/manual/strategies/{key}/deactivate"),
    ("GET", "/api/v1/crypto/manual/positions"),
    ("GET", "/api/v1/crypto/manual/calendar"),
    ("POST", "/api/v1/crypto/manual/positions/{position_id}/sell"),
    ("GET", "/api/v1/crypto/strategy-catalog"),
    ("DELETE", "/api/v1/crypto/strategy-catalog/{key}"),
    ("GET", "/api/v1/crypto/strategy-catalog/{key}/report"),
    ("GET", "/api/v1/crypto/strategy-catalog/{key}/export"),
    ("GET", "/api/v1/crypto/leaderboard"),
    ("GET", "/api/v1/leaderboard/real-trading"),
    ("GET", "/api/v1/manual10/status"),
    ("GET", "/api/v1/manual10/settings"),
    ("PUT", "/api/v1/manual10/settings"),
    ("GET", "/api/v1/manual10/strategies"),
    ("POST", "/api/v1/manual10/strategies/upload"),
    ("POST", "/api/v1/manual10/strategies/{key}/approve"),
    ("POST", "/api/v1/manual10/strategies/{key}/reject"),
    ("DELETE", "/api/v1/manual10/strategies/{key}"),
    ("POST", "/api/v1/manual10/strategies/{key}/select"),
    ("POST", "/api/v1/manual10/strategies/{key}/deselect"),
    ("POST", "/api/v1/manual10/strategies/{key}/activate"),
    ("POST", "/api/v1/manual10/strategies/{key}/deactivate"),
    ("GET", "/api/v1/manual10/screener"),
    ("GET", "/api/v1/manual10/positions"),
    ("GET", "/api/v1/manual10/calendar"),
    ("POST", "/api/v1/manual10/positions/{position_id}/sell"),
    ("POST", "/api/v1/manual10/positions/{position_id}/promote"),
    ("POST", "/api/v1/manual10/positions/{position_id}/demote"),
    ("GET", "/api/v1/connections"),
    ("GET", "/api/v1/connections/providers"),
    ("PUT", "/api/v1/connections/{provider}"),
    ("DELETE", "/api/v1/connections/{provider}"),
    ("GET", "/api/v1/connections/paper-wallet"),
    ("PUT", "/api/v1/connections/paper-wallet"),
    ("GET", "/api/v1/strategy-testing/queue"),
    ("POST", "/api/v1/strategy-testing/submit"),
    ("POST", "/api/v1/strategy-testing/{item_id}/delete"),
    ("POST", "/api/v1/strategy-testing/{item_id}/add"),
    ("GET", "/api/v1/strategy-testing/{item_id}/export"),
    ("GET", "/api/v1/prediction/notice"),
    ("POST", "/api/v1/prediction/strategies/manual"),
    ("POST", "/api/v1/prediction/strategies/upload"),
    ("GET", "/api/v1/prediction/strategies"),
    ("GET", "/api/v1/prediction/strategies/{strategy_id}"),
    ("POST", "/api/v1/agents/upload"),
    ("POST", "/api/v1/prediction/strategies/{strategy_id}/add"),
    ("POST", "/api/v1/prediction/strategies/{strategy_id}/delete"),
}
