"""RSI-14 Reversion for the crypto dashboard. Buy oversold (RSI14 < 30), exit on recovery (RSI14 > 55). The classic oscillator play.
...
class RsiReversionStrategy(CryptoBaselineStrategy):
    key = "cx_rsi_reversion"
