"""Volatility Breakout for the crypto dashboard. Enter when price jumps more than 1.5 twenty-day standard deviations above yesterday's close; exit below SMA(10).
...
class VolBreakoutStrategy(CryptoBaselineStrategy):
    key = "cx_vol_breakout"
