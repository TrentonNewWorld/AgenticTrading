"""20-Day Momentum Rank for the crypto dashboard. Hold the top 2 symbols by trailing 20-day return, re-ranked daily.
...
class MultidayMomentumStrategy(CryptoBaselineStrategy):
    key = "cx_multiday_momentum"
