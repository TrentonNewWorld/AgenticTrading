"""Z-Score Mean Reversion for the crypto dashboard. Buy 20-day z-score below -1.5, exit when it recrosses zero.
...
class ZscoreMeanrevStrategy(CryptoBaselineStrategy):
    key = "cx_zscore_meanrev"
