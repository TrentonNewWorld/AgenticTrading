"""Trend-Filtered Dip Buyer for the crypto dashboard. Only in uptrends (price above SMA50): buy a 3-day pullback, exit if the trend breaks.
...
class TrendDipStrategy(CryptoBaselineStrategy):
    key = "cx_trend_dip"
