"""SMA 10/30 Cross for the crypto dashboard. Golden-cross style trend filter per symbol: hold while SMA(10) is above SMA(30).
...
class SmaCrossStrategy(CryptoBaselineStrategy):
    key = "cx_sma_cross"
