"""Donchian 20/10 Breakout for the futures dashboard. Turtle-style channel breakout: enter on a 20-day high, exit on a 10-day low.
...
class DonchianBreakoutStrategy(FuturesBaselineStrategy):
    key = "fut_donchian_breakout"
