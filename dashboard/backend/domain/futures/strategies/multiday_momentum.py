"""20-Day Momentum Rank for the futures dashboard. Hold the top 2 symbols by trailing 20-day return, re-ranked daily.
...
class MultidayMomentumStrategy(FuturesBaselineStrategy):
    key = "fut_multiday_momentum"
