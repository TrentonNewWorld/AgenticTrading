"""EMA Ribbon 8/21/50 for the futures dashboard. Hold while the EMA ribbon (8 over 21 over 50) is stacked bullish.
...
class EmaRibbonStrategy(FuturesBaselineStrategy):
    key = "fut_ema_ribbon"
