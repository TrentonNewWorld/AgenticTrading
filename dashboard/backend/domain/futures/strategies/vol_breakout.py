"""Volatility Breakout for the futures dashboard. Enter when price jumps more than 1.5 twenty-day standard deviations above yesterday's close; exit below SMA(10).
...
class VolBreakoutStrategy(FuturesBaselineStrategy):
    key = "fut_vol_breakout"
