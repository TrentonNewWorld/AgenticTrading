"""EMA Ribbon 8/21/50 for the forex dashboard. Hold while the EMA ribbon (8 over 21 over 50) is stacked bullish.
...
class EmaRibbonStrategy(ForexBaselineStrategy):
    key = "fx_ema_ribbon"
