"""Trend-Filtered Dip Buyer for the forex dashboard. Only in uptrends (price above SMA50): buy a 3-day pullback, exit if the trend breaks.
...
class TrendDipStrategy(ForexBaselineStrategy):
    key = "fx_trend_dip"
