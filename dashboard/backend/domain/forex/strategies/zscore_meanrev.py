"""Z-Score Mean Reversion for the forex dashboard. Buy 20-day z-score below -1.5, exit when it recrosses zero.
...
class ZscoreMeanrevStrategy(ForexBaselineStrategy):
    key = "fx_zscore_meanrev"
