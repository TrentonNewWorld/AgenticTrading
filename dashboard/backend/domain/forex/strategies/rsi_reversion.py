"""RSI-14 Reversion for the forex dashboard. Buy oversold (RSI14 < 30), exit on recovery (RSI14 > 55). The classic oscillator play.
...
class RsiReversionStrategy(ForexBaselineStrategy):
    key = "fx_rsi_reversion"
