"""Donchian 20/10 Breakout for the forex dashboard. Turtle-style channel breakout: enter on a 20-day high, exit on a 10-day low.
...
class DonchianBreakoutStrategy(ForexBaselineStrategy):
    key = "fx_donchian_breakout"
